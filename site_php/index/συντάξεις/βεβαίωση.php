...
if($correct_input)
{
  ...
  else
  {
    ...
    if($type == 1)
      header("Location: ../βεβαίωση_συνταξιούχου.php");
    else
      $submitErr = "Δεν είσαι εγγεγραμένος ως συνταξιούχος!";
...
<body>
  ...
  <div class="wrapper row2">
    ...
    <div class="title">
    <a class="title-link" href="../πληροφορίες_για_συνταξιούχους.php">Πληροφορίες για Συνταξιούχους</a> / Δικαιολογητικά</div>
      <!-- content body -->
      <div id="homepage">
        <div class="container_form">
          <form method="post" action="">
            <table>
            <tr>Για να λάβεις την βεβαίωση, απλά κάνε σύνδεση εδώ στον Ατομικό Λογαριασμό Ασφάλισής σου.</tr>
